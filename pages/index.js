...
export default function Home({ posts }) {
  ...
  return (
    <div className="relative bg-gray-500 shadow-[0px_4px_100px_rgba(255,_255,_255,_0.14)] [border:1px_solid_#fff] box-border w-full h-screen flex flex-col p-[0px_64px] items-center justify-center md:pl-[24px] md:pr-[2px] md:box-border sm:pl-[16px] sm:pr-[16px] sm:box-border">
